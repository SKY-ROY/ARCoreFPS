namespace GoogleARCore.Examples.Common
{
    ...
    /// </summary>
    public class AlteredPlaneGenerator : MonoBehaviour
    {
        /// <summary>
        /// Time period to keep the plane on screen
        /// </summary>
        public float n = 1f;
        ...
        public void Update()
        {
            ...
            for (int i = 0; i < m_NewPlanes.Count; i++)
            {
                ...
                //Destroy the generated plane after n seconds of visualization
                Destroy(planeObject, n);
            }
        }
    }
}
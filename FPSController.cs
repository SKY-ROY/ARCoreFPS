...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    public class FPSController : MonoBehaviour
    {
            ...
            if (Frame.Raycast(touch.position.x, touch.position.y, raycastFilter, out hit))
            {
                ...
                else
                {
                    ...
                    else if (hit.Trackable is DetectedPlane)
                    {
                        ...
                        ///<summary>
                        ///instantiate world only on horizontal plane(upward facing) and point once.
                        ///</summary>
                    }
                    else
                    {
        ...
        /// <summary>
        /// To instantiate different objects for downward and upward facing planes
        /// </summary>
        /*
        private GameObject SwitchHorizontalPrefab(DetectedPlane detectedPlane)
        {
            GameObject prefab;

            if (detectedPlane.PlaneType == DetectedPlaneType.HorizontalUpwardFacing)
            {
                prefab = GameObjectHorizontalPlanePrefabUpward;
            }
            else //if (detectedPlane.PlaneType == DetectedPlaneType.HorizontalDownwardFacing)
            {
                prefab = GameObjectHorizontalPlanePrefabDownward;
            }
            return prefab;
        }
        */
